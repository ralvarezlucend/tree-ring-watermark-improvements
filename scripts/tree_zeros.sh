...
python run_tree_ring_watermark.py --run_name blurring_zeros_optimized_100 --w_channel 2 --w_pattern zeros --gaussian_blur_r 4 --start 0 --end 100 --with_tracking --optimize_latents
python run_tree_ring_watermark.py --run_name noise_zeros_optimized_100 --w_channel 2 --w_pattern zeros --gaussian_std 0.1 --start 0 --end 100 --with_tracking --optimize_latents
python run_tree_ring_watermark.py --run_name color_jitter_zeros_optimized_100 --w_channel 2 --w_pattern zeros --brightness_factor 6 --start 0 --end 100 --with_tracking --optimize_latents

### fid
# python run_tree_ring_watermark_fid.py --run_name fid_run --w_channel 2 --w_pattern zeros --start 0 --end 5000 --with_tracking --run_no_w
